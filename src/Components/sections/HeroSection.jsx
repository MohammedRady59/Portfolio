...
function HeroSection() {
  ...
  return (
    ...
    >
      ...
      <div className="glow-orb w-96 h-96 bg-emerald-500/10 top-10 left-1/4 -translate-x-1/2"></div>
      <div className="glow-orb w-[30rem] h-[30rem] bg-teal-500/10 bottom-10 right-1/4 translate-x-1/2"></div>
      ...
      <div className="container relative z-10 mx-auto px-4">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div
            data-aos="fade-down"
            className="inline-flex items-center gap-2 px-4 py-2 rounded-full glass-card mb-8 border border-emerald-500/20 text-xs sm:text-sm text-emerald-400 font-nav tracking-wide"
          >
          ...
          <p
            data-aos="fade-up"
            data-aos-delay="100"
            className="text-emerald-400 font-nav text-sm sm:text-base md:text-lg mb-2 tracking-widest uppercase font-semibold"
          >
            Hello World, I'm
          </p>
          ...
          >
            <span className="text-gradient hover:drop-shadow-[0_0_35px_rgba(16,185,129,0.5)] transition-all duration-300">
              Mohamed Rady
            </span>
          </h1>
          ...
          >
            ...
            <span
              ref={typedEl}
              className="text-gradient-cyan font-semibold border-b-2 border-emerald-400/30 pb-0.5"
            ></span>
          </div>
          ...
          >
            ...
            with <span className="text-emerald-300 font-medium">React</span>,{" "}
            <span className="text-emerald-300 font-medium">Next.js</span>, and modern
          ...
          >
            <a
              href="#projects"
              className="group relative inline-flex items-center gap-2.5 px-7 py-3.5 rounded-xl bg-gradient-to-r from-emerald-500 to-teal-600 text-white font-medium text-base shadow-glow hover:shadow-glow-lg transition-all duration-300 hover:scale-[1.03] active:scale-[0.98]"
            >
            ...
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="inline-flex items-center gap-2.5 px-6 py-3.5 rounded-xl glass-card text-slate-200 hover:text-white hover:border-emerald-400/40 font-medium text-base transition-all duration-300 hover:scale-[1.03] active:scale-[0.98]"
            >
          ...
          >
            <a
              ...
              className="p-3 rounded-xl glass-card text-slate-400 hover:text-white hover:bg-[#131f1a] hover:scale-110 transition-all duration-300"
            >
            ...
            <a
              ...
              className="p-3 rounded-xl glass-card text-slate-400 hover:text-emerald-400 hover:bg-[#131f1a] hover:scale-110 transition-all duration-300"
            >
            ...
            <a
              ...
              className="p-3 rounded-xl glass-card text-slate-400 hover:text-teal-400 hover:bg-[#131f1a] hover:scale-110 transition-all duration-300"
            >
          ...
          >
            ...
            <div className="glass-card p-4 sm:p-5 rounded-2xl text-center group hover:border-teal-500/40">
              <div className="w-10 h-10 mx-auto mb-2 rounded-xl bg-teal-500/10 flex items-center justify-center text-teal-400 group-hover:scale-110 transition-transform">
